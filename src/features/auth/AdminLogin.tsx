        ...
        {!isRegistering ? (
          ...
          <div className="space-y-4">
            ...
            <form onSubmit={handleRegisterSubmit} className="space-y-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-center pt-2">
                    <button
                      ...
                      className="text-xs font-bold text-primary-medium hover:text-primary-dark transition-colors cursor-pointer border-none bg-transparent"
                    >
              ...
              {currentStep === 3 && (
                <div className="space-y-4">
                  <div className="text-center p-4 bg-black/[0.02] dark:bg-white/[0.02] rounded-2xl border border-gray-100 dark:border-zinc-800/50">
